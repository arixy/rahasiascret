...
export class PerformanceReportService {
    ...
    getPerformancesAsReport(filters) {
        ...
        var load_url = this.appUrl + '/report/performance-report';
    ...
    public exportPerformanceReport(filters: any) {
        var bearer = "Bearer " + localStorage.getItem('bearer_token');
        ...
        var load_url = this.appUrl + '/report/performance-report/export';
        console.log('Options ', options);
